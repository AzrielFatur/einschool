...
@section('content')
        <div class="breadcump">
            <h2 class="float-left">Data Management <small> > Add Teacher</small></h2>
        </div>
        <br><br><br>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nig" required class="form-control" placeholder="Nomor Induk Guru">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="phone_number" required class="form-control" placeholder="Nomor Telpon">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="address">Address</label>
                            <textarea name="address" required class="form-control" placeholder="Alamat"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-4">
                <a href="javascript:changeProfile()">
                    <div class="upload">
                        ...
                        <input type="file" required name="photo" id="image" style="display: none;"/>
                    </div>
                </a>
            </div>
        </div>
